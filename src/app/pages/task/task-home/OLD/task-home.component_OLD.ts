...
//   onRedirectToEditPage = (data: ITaskHome): void => {
...
//       `/${this.deptName}/${this.currentView}/edit/${(this.baseRegisterStore.data() as ITaskHome).idTask}`
//     );
//   };

//   onCloneRegister = async (data: ITaskHome): Promise<void> => {
...
//       if (response.data) {
//         const dataList = response.data as ITaskHome[];
...
//   async onDelete(data: ITaskHome): Promise<void> {
//     await this.onDeleteRegister(data.idTask as number);
//   }

//   onShowModalToDelete(data?: ITaskHome): void {
//     const selectedData = data ? data : (this.baseRegisterStore.itemSelected() as ITaskHome) || '';
